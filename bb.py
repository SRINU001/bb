...
if(expirydate>today):
    ...
    while(True):
        ...
        print(f"If It Does'nt Open Contact Me On Telegram {yellow}s")
        print(f"{neon}*---------*----------*-------------*----------*")
        print(f"{red}*---------*----------*-------------*----------*")
        print("payhere--- UPI : ")
        print(f"{yellow}UPI1 : s")
        print("UPI2 : s")
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("16th Mar 2022, 10:30 AM- 11:30 PM")
            print("16th Mar 2022, 03:30 PM- 05:00 PM")
            print("16th Mar 2022, 08:30 PM- 09:00 PM")
            print("Please play on the given time, and ")
